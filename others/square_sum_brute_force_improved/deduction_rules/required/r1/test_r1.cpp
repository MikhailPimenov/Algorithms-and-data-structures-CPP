//#include "test_r1.h"
//
//void test_r1(void (*algorithm)(int, Graphs_t &graphs)) {
//	std::cout << "test_r1:\n";
//
//	Graph_t graph;
//	Graph_t undecided_actual;
//	Graph_t undecided_expected;
...
//	
//	undecided_actual = graph;
//
//	undecided_expected.insert(std::pair<int, Vertexes_t>(second_vertex, Vertexes_t()));
//	undecided_expected.insert(std::pair<int, Vertexes_t>(current_vertex, Vertexes_t{ 3, 4, 5 }));
//	undecided_expected.insert(std::pair<int, Vertexes_t>(3, Vertexes_t()));
//	undecided_expected.insert(std::pair<int, Vertexes_t>(4, Vertexes_t()));
//	undecided_expected.insert(std::pair<int, Vertexes_t>(5, Vertexes_t()));
//
